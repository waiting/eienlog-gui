...
size_t Poll::enumEvents( EvtFn cbEvt )
{
    size_t c = 0;
...
// class IoEventsData -------------------------------------------------------------------------
IoEventsData::IoEventsData() : _mtxPreIoCtxs(true), _mtxIoVecMap(true), _portSockWakeUp(0), _sockIoCount(0), _timerIoCount(0)
{
...
{
    this->_poll.enumEvents( [this] ( int fd, short events ) {
